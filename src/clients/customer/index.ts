...
import type { CustomerCardCreate, CustomerCardResponse } from './create/types';
...
export class CustomerCard {
	 ...
	 *
	 * @see {@link https://github.com/mercadopago/sdk-nodejs/blob/master/examples/src/customer/create/create.ts Usage Example  }.
	 */
	 ...
	 *
	 * @see {@link https://github.com/mercadopago/sdk-nodejs/blob/master/examples/src/customer/get/get.ts Usage Example  }.
	 */
	 ...
	 *
	 * @see {@link https://github.com/mercadopago/sdk-nodejs/blob/master/examples/src/customer/remove/remove.ts Usage Example  }.
	 */
	 ...
	 *
	 * @see {@link https://github.com/mercadopago/sdk-nodejs/blob/master/examples/src/customer/update/update.ts Usage Example  }.
	 */
	 ...
	 *
	 * @see {@link https://github.com/mercadopago/sdk-nodejs/blob/master/examples/src/customer/list/list.ts Usage Example  }.
	 */
