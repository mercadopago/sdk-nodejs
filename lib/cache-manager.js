 ...
 * @returns {*}
 */
cacheManager.generateCacheKey = function(path, headers, payload, querystring){
    return hash({ path: path, headers: headers, payload: payload, querystring: querystring }, { algorithm: this.algorithm, encoding: this.encoding });
};