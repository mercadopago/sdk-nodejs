...
var mercadopagoResponse = function mercadopagoResponse(body, status, idempotencyId, pagination, options, requestManagerInjection) {
  ...
  // This will return a the body showing a deprecated warning
  this.response = (function (responseBody) {
    if (!configurations.areTestsRunnning()) {
      console.warn('The use of response is deprecated deprecated and its going to be remove on next versions. ' +
        'Plase use MercadoPagoResponse.body');
    }
    return responseBody;
  }).call(this, body);
};
